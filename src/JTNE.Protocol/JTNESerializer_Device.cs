...
namespace JTNE.Protocol
{
    ...
    /// 
    /// </summary>
    public static class JTNESerializer_Device
    {
        public static byte[] Serialize(JTNEPackage_Device jTNEPackage_Device, int minBufferSize = 256)
        {
            return Serialize<JTNEPackage_Device>(jTNEPackage_Device, minBufferSize);
        }

        public static JTNEPackage_Device Deserialize(ReadOnlySpan<byte> bytes)
        {
            return Deserialize<JTNEPackage_Device>(bytes);
        }
