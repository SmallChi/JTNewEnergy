...
namespace JTNE.Protocol.MessageBody
{
    ...
    /// 燃料电池数据
    /// </summary>
    [JTNEFormatter(typeof(JTNE_0x02_0x03_Device_Formatter))]
    public class JTNE_0x02_0x03_Device : JTNE_0x02_Body_Device
    {
        public override byte TypeCode { get; set; } = JTNE_0x02_0x03_Device;
