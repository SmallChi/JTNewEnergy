...
namespace JTNE.Protocol.MessageBody
{
    ...
    /// 终端控制
    /// </summary>
    public class  JTNE_0x82_Body_Device
    {
        /// <summary>
        /// 未用
        /// </summary>
        ...
        static JTNE_0x82_Body_Device()
        {
            JTNE_0x82Method = new Dictionary<byte, Type>();
            JTNE_0x82Method.Add(JTNE_0x82_0x01_Type, typeof(JTNE_0x82_0x01_Device));
            JTNE_0x82Method.Add(JTNE_0x82_0x06_Type, typeof(JTNE_0x82_0x06_Device));
        }
    }
}
