...
namespace JTNE.Protocol.MessageBody
{
    ...
    /// 报警数据
    /// </summary>
    [JTNEFormatter(typeof(JTNE_0x02_0x07_Platform_Formatter))]
    public class JTNE_0x02_0x07_Platform : JTNE_0x02_Body_Platform
    {
        public override byte TypeCode { get; set; } = JTNE_0x02_0x07_Platform;
