...
namespace JTNE.Protocol.MessageBody
{
    ...
    /// 车辆位置数据
    /// </summary>
    [JTNEFormatter(typeof(JTNE_0x02_0x05_Device_Formatter))]
    public class JTNE_0x02_0x05_Device : JTNE_0x02_Body_Device
    {
        public override byte TypeCode { get; set; } = JTNE_0x02_0x05_Device;
