...
namespace JTNE.Protocol.MessageBody
{
    ...
    /// 整车数据
    /// </summary>
    [JTNEFormatter(typeof(JTNE_0x02_0x01_Device_Formatter))]
    public class JTNE_0x02_0x01_Device : JTNE_0x02_Body_Device
    {
        public override byte TypeCode { get; set; } = JTNE_0x02_0x01_Device;
